...
#登录
def login():
    driver.get('http://125.71.30.136/')
    driver.maximize_window()
    driver.find_element_by_id("txtUser").send_keys("scyg_shm")
...
def check():
    ...
    driver.find_element_by_xpath("//*[@id='level_nav']/label[1]").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[1]/td/a/label").click()    
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='level_nav']/label[1]").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[2]/td/a/label").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='level_nav']/label[1]").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[3]/td/a/label").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='level_nav']/label[1]").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[4]/td/a/label").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='level_nav']/label[1]").click()
    time.sleep(2)
#查询安装数
def vihicleinstall():
    WebDriverWait(driver, 15).until(lambda x:x.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[3]/td/a/label").is_displayed()) 
    driver.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[3]/td/a/label").click()
    time.sleep(2)
...
#地区汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel0_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel0_form0_datePeriod0_date1_txt']").clear()
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel0_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#接入平台汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel1_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel1_form0_datePeriod0_date1_txt']").clear()
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel1_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#企业汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").clear()
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#车辆安装明细
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel3_form0_date0_txt']").send_keys("2017-03-15")
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").clear()
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
#选安装类型
...
#新装车辆明细
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel4_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel4_form0_datePeriod0_date1_txt']").clear()
    driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel4_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
def sixban():
    time.sleep(20)
    WebDriverWait(driver, 30).until(lambda x:x.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[4]/td/a").is_displayed()) 
    driver.find_element_by_xpath("//*[@id='home-index']/div[1]/div[2]/table/tbody/tr[4]/td/a").click()
    time.sleep(20)
#地区汇总
    driver.find_element_by_id("pro-table-div_tabs0_content_panel0_form0_datePeriod0_date0_txt").clear()
    driver.find_element_by_id("pro-table-div_tabs0_content_panel0_form0_datePeriod0_date0_txt").send_keys("2017-02-22")
    driver.find_element_by_id("pro-table-div_tabs0_content_panel0_form0_datePeriod0_date1_txt").clear()   
    driver.find_element_by_id("pro-table-div_tabs0_content_panel0_form0_datePeriod0_date1_txt").send_keys("2017-03-15")
#选车辆类型
    ...
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/ZoneTable.png")
...
#接入平台汇总
    ...
    driver.find_element_by_id("pro-table-div_tabs0_content_panel1_form0_datePeriod0_date0_txt").send_keys("2017-02-22")
    driver.find_element_by_id("pro-table-div_tabs0_content_panel1_form0_datePeriod0_date1_txt").clear()   
    driver.find_element_by_id("pro-table-div_tabs0_content_panel1_form0_datePeriod0_date1_txt").send_keys("2017-03-15")
#选车辆类型
    ...
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/PlatformTable.png")
...
#企业汇总
    ...
    driver.find_element_by_id("pro-table-div_tabs0_content_panel2_form0_datePeriod0_date0_txt").send_keys("2017-02-22")
    driver.find_element_by_id("pro-table-div_tabs0_content_panel2_form0_datePeriod0_date1_txt").clear()   
    driver.find_element_by_id("pro-table-div_tabs0_content_panel2_form0_datePeriod0_date1_txt").send_keys("2017-03-15")
#选车辆类型
    ...
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/UnitTable.png")
...
#车辆汇总
    ...
    driver.find_element_by_id("pro-table-div_tabs0_content_panel3_form0_datePeriod0_date0_txt").send_keys("2017-02-22")
    driver.find_element_by_id("pro-table-div_tabs0_content_panel3_form0_datePeriod0_date1_txt").clear()   
    driver.find_element_by_id("pro-table-div_tabs0_content_panel3_form0_datePeriod0_date1_txt").send_keys("2017-03-15")
#选车辆类型
    ...
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/VehicleTable.png")
...
#超速违章次数
    ...
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel4_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel4_form0_datePeriod0_date1_txt']").clear()   
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel4_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
#选车辆类型
    ...
    print e
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/OverSpeed.png")
#异动违章次数
    ...
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel5_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel5_form0_datePeriod0_date1_txt']").clear()   
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel5_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
#选车辆类型
    ...
    print f  
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/Abnormal.png")
#定位中断违章次数
    ...
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel6_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel6_form0_datePeriod0_date1_txt']").clear()   
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel6_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
#选车辆类型
    ...
    print g
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/PositionBreak.png")
#超4小时运行违章次数
    ...
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel7_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel7_form0_datePeriod0_date1_txt']").clear()   
    driver.find_element_by_xpath("//*[@id='pro-table-div_tabs0_content_panel7_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
#选车辆类型
    ...
    print h  
    time.sleep(1)
    driver.get_screenshot_as_file(u"E:/Dailydata/2017-03-15/Over4hours.png") 
#返回首页    
    driver.find_element_by_xpath("//*[@id='level_nav']/label[1]").click()
    time.sleep(2)     
...
#地区汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleonline_table_div_tabs0_content_panel0_form0_date0_txt']").send_keys("2016-12")
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel0_form0_datePeriod0_date1_txt']").clear()
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel0_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#接入平台汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleonline_table_div_tabs0_content_panel1_form0_date0_txt']").send_keys("2016-12")
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel1_form0_datePeriod0_date1_txt']").clear()
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel1_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#企业汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleonline_table_div_tabs0_content_panel2_form0_date0_txt']").send_keys("2016-12")
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").clear()
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#     driver.find_element_by_xpath("//*[@id='report_vehicleonline_table_div_tabs0_content_panel3_form0_date0_txt']").send_keys("2016-12")
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").clear()
#     driver.find_element_by_xpath("//*[@id='report_vehicleinstall_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
def uplinerate():
    ...
    time.sleep(2)
#     driver.find_element_by_xpath("//*[@id='report-index']/div[1]/div/p[1]").click()
    driver.find_element_by_xpath("//*[@id='report_vehicle']/li[4]/a").click()
    time.sleep(2)
#地区汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel0_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel0_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#接入平台汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel1_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel1_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#企业汇总
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel2_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel2_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#上线车辆明细
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel3_form0_datePeriod0_date0_txt']").send_keys("2017-02-22")
    ...
    driver.find_element_by_xpath("//*[@id='report_vehicleuplinerate_table_div_tabs0_content_panel3_form0_datePeriod0_date1_txt']").send_keys("2017-03-15")
...
#查车、历史轨迹
def vehicle_monitor():
    WebDriverWait(driver, 15).until(lambda x:x.find_element_by_xpath("//*[@id='home-down-icon']").is_displayed()) 
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='home-down-icon']").click()
    time.sleep(2)
#     driver.find_element_by_xpath("//*[@id='report-index']/div[1]/div/p[1]").click()
    driver.find_element_by_xpath("//*[@id='vehicle_monitor']/span").click()
    time.sleep(2)
    driver.find_element_by_xpath("//*[@id='monitor_search_txt']").clear()
    driver.find_element_by_xpath("//*[@id='monitor_search_txt']").send_keys(u"川AS9013")  #为什么可以选到
    time.sleep(2)
    WebDriverWait(driver, 15).until(lambda x:x.find_element_by_xpath("//*[@id='ui-id-1']").is_displayed()) 
    driver.find_element_by_xpath("//*[@id='ui-id-1']").click()
    driver.find_element_by_xpath("//*[@id='monitor_search']").click()
    time.sleep(5)
    driver.find_element_by_xpath("//*[@id='monitor-vehicle']/a[1]").click()
    driver.find_element_by_xpath("//*[@id='history_track_play']").click()
